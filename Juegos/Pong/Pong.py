...
imagenPresent = pygame.image.load("introPong.png")
...
rectanguloTextoPresent.centerx = main_surface.get_rect().centerx
...
class Paddle(pygame.sprite.Sprite):
    def __init__(self, player_number):
        ...
        ### Establecemos la localicación de estas ##
...
while partidaEnMarcha:
    ...
    main_surface.blit(imagenPresent,rectanguloPresent)
    main_surface.blit(imagenTextoPresent, rectanguloTextoPresent)
    pygame.display.flip()
    entrarAlJuego = False
